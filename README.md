...
- `GET /api/player-cards/:name.png` — returns a PNG player card.
- `GET /api/player-cards/:name.svg` — returns the rendered SVG player card when `DISABLE_SVG` is not enabled.
